...
const ContactPopup = () => {
    ...
    return (
        <>
            {/* Nút liên hệ */}
            <button
                className="fixed bottom-10 right-10 bg-gradient-to-r from-[#D0C49E] to-[#A79268] text-black py-[0.22rem] px-2 sm:py-2 sm:px-4 rounded-lg border-2 font-semibold"
