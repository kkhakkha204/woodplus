        ...
        <div className="w-full flex justify-center items-center pt-14 md:pt-0">
            <div className="w-full max-w-[1620px] grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex lg:hidden flex-col space-y-8">
                    ...
                    {[
                        {name: "Anh Đức Quân", location: "Eco City Thanh Trì", img: "test1.jpg", review: "Nhà đẹp, hiện đại với giá hợp lý, đội ngũ tư vấn trẻ trung, chuyên nghiệp, nhiệt tình. Highly recommend!"},
                        {name: "Youtuber Lê Hoàng Nam", location: "Ocean Park", img: "test2.webp", review: "Nhà không chỉ đẹp mà còn khiến mọi người trầm trồ, tự hào. Mong phong cách Indochine trở nên phổ biến, cảm ơn ekip WoodPlus đã biến ý tưởng thành hiện thực."}
                ...
                <div className="relative space-y-8">
                    {[
                        {name: "Chị Hiền Nguyễn", location: "Biệt thự La Phù", img: "test1.jpg", review: "Ngôi nhà là tâm huyết, và chọn WoodPlus là quyết định sáng suốt. Cảm ơn đội ngũ đã mang đến căn nhà đúng mong muốn của gia đình."},
                        {name: "Chị Yến", location: "Duplex Royal City", img: "test2.webp", review: "Dù mặt bằng căn hộ khó, WoodPlus vẫn hoàn thiện tối đa cả thẩm mỹ lẫn công năng. Đội ngũ trẻ đầy tâm huyết đã biến mọi ý tưởng thành hiện thực."}
                    ].map((testimonial, index) => (
                        <div key={index} className="relative w-full max-w-[650px] h-[300px] md:h-[400px] mx-auto">
                            <img src={`/assets/images/testimonials/${testimonial.img}`} alt={testimonial.name} className="w-full h-full object-cover" />
                            <div className="absolute bottom-0 left-0 w-3/4 sm:w-[300px] md:w-[375px] bg-[#0F0F0F] bg-opacity-85 p-4">
                ...
                <div className="hidden lg:flex flex-col space-y-8">
                    ...
                    {[
                        {name: "Anh Đức Quân", location: "Eco City Thanh Trì", img: "test3.jpg", review: "Nhà đẹp, hiện đại với giá hợp lý, đội ngũ tư vấn trẻ trung, chuyên nghiệp, nhiệt tình. Highly recommend!"},
                        {name: "Youtuber Lê Hoàng Nam", location: "Ocean Park", img: "test4.jpg", review: "Nhà không chỉ đẹp mà còn khiến mọi người trầm trồ, tự hào. Mong phong cách Indochine trở nên phổ biến, cảm ơn ekip WoodPlus đã biến ý tưởng thành hiện thực."}
                    ].map((testimonial, index) => (
