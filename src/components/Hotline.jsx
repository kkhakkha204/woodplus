...
const Hotline = () => {
    return (
        <a
            ...
            className="fixed bottom-1 left-1 sm:bottom-10 sm:left-10 bg-[#272727] text-white py-[0.22rem] px-2 sm:py-2 sm:px-4 border-2 font-medium sm:font-semibold transition duration-300 flex items-center gap-2 hover:bg-[#BEAB81] hover:text-black"
        >
            {/* Icon Điện Thoại */}
